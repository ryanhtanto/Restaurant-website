...
$result = mysqli_query($koneksi, "SELECT * FROM menu JOIN kategori USING(id_kategori) WHERE nama_kategori ='drinks'");
                            ...
                            <div class="card" style="width: 18rem; margin-right:20px; margin-bottom:20px;background-color:white;border-radius: 15px;box-shadow: 0px 15px 20px rgba(0,0,0,0.1);">
                                <form method="post" action="order.php">
                                    ...
                                    <div class="card-body text-center">
                                        <h5 class="card-title" name="menu_nama"><?php echo $info["nama_menu"]; ?></h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <input type="number" min="1" name="quantity"  class="form-control" style="width:70px; boder:#d4d6d9;" required/>
                                            </div>
                                        </div>
                                    </div>
                                </form>
